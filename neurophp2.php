<?php
$allinput = [
    [-10, 4.5398899216871E-5],
    [-9.9, 5.0173423349002E-5],
    [-9.8, 5.5450062049104E-5],
    [-9.7, 6.1281617296633E-5],
    [-9.6, 6.7726443003429E-5],
    [-9.5, 7.4849028629212E-5],
    [-9.4, 8.2720644109717E-5],
    [-9.3, 9.1420052537884E-5],
    ...
    [-1.8790524691781E-14, 0.69314718055994],
...
$hidden_layer2 = array(
    "brain" => [
        [lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value()],
        [lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value()],
        [lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value()],
        [lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value()],
        [lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value()],
...
$output_layer = array(
    "brain" => [lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value(), lcg_value()],
    "data" => 0
);
...
function check_all()
{
    ...
    foreach ($allinput as $current) {
        $input = $current[0] / 10;
        calculate();
        echo $input * 10 . " expected: " . $current[1] . " got: " . $output_layer["data"] * 10 . PHP_EOL;
    }
}
